...
export default function ProfilePage() {
  ...
  useEffect(() => {
    ...
    console.log('Profile effect triggered:', { profile: !!profile, activeTab, postsLength: posts.length });
    if (profile && activeTab === 'posts' && posts.length === 0) {
      console.log('Calling loadPosts from profile effect');
      loadPosts();
    }
  ...
  useEffect(() => {
    ...
    console.log('Tab effect triggered:', { activeTab, commentsLength: comments.length });
    if (profile) {
      if (activeTab === 'comments' && comments.length === 0) {
        console.log('Calling loadComments from tab effect');
        loadComments();
      }
    }
    // eslint-disable-next-line react-hooks/exhaustive-deps
